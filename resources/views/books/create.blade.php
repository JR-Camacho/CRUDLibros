...
@section("main")
<h1 class="title display-1">New Book</h1>
<div class="container_form">
    <form class="form" action="{{url('/books')}}" method="post" enctype="multipart/form-data">
        <div class="mb-3">
            <label for="title" class="form-label">Title</label>
            <input type="text" class="form-control" id="title" name="title" aria-describedby="emailHelp" placeholder="Ex: Don Quijote de la Mancha" autofocus>
            @error('title')
